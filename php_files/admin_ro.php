...
<div class="body-container container-fluid">
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-lg-2 col-md-3 col-12 menu_block">
            ...
            <!--admin options menu-->
            <div class="side_menu_section">
                <h4 class="side_title">Opțiuni:</h4>
                <ul class="menu_nav">
                    <li><a href="add_photos.php">Adaugă poze</a></li>
                            ...
                            <div class="content_box">
                                <div class="content_box_inner">
                                    <form action="change_chat.php" method="post">
                                        ...
                                        <button class="btn btn-primary-outline col-lg-6 col-12" type="submit">Conversație</button>
                                    </form>
                                    <br><h4>Listă de utilizatori</h4><br>
                                    <?php
