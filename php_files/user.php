...
<head>
    ...
    <link rel="stylesheet" href="assets/css/user_chat.css" type="text/css">  
</head>
<body>
<div class="loader">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-7 content_section">
                            ...
                            <div class="content_box">
                                ...
                                <h3><?php echo "MDphoto - ".$first_name;?></h3>
                                    <div class="chatbox col-12">
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                            if($row['email']==$dest&&$row['dest']==$email){ 
                                                echo "<h4>MDPhoto: </h4><p style='word-wrap: break-word;'>".$row['message']."</p><br>";
                                            } else if($row['email']==$email){
                                                echo "<h4>".$first_name.": </h4><p style='word-wrap: break-word;'>".$row['message']."</p><br>";
                                            }
                                        }
                                        }
                                        $conn->close();
